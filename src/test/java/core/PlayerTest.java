...
public class PlayerTest extends TestCase {
	...
	/*
	 * public void testCreateMeld() { // initializing Deck MainDeck = new Deck();
	 ...
	 * 
	 * 
	 * // testing return value is of type meld assertEquals(** MELD RETURN
	 * **,Julian.makeMeld(Julian.getCard(),Julian.getCard(),Julian.getCard()));
	 * 
	 * }
	 * 
	 * /* public void testEditMeld() { // initializing Deck MainDeck = new Deck();
	 * Player Julian = new Player(); Meld meld;
	 * 
	 * // adding tiles Julian.addTile(new Tile(R,5)); Julian.addTile(new Tile(R,6));
	 ...
	 * 
	 * // testing return value is of type meld assertEquals();
	 * 
	 * }
	 * 
	 * public void test_toSting() { // initializing Deck MainDeck = new Deck();
	 * Player Julian = new Player();
	 * 
	 * 
	 * // adding tiles Julian.addTile(new Tile(R,10)); Julian.addTile(new
